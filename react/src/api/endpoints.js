...
export const SENTENCE_QUIZ_API_ENDPOINT = 'https://58j3sff8ah.execute-api.us-east-1.amazonaws.com/prod/';
export const CREATE_EXAM_API_ENDPOINT = 'https://kx33bx89k9.execute-api.us-east-1.amazonaws.com/prod/';
export const EXAM_API_ENDPOINT = 'https://iud3cyhrx6.execute-api.us-east-1.amazonaws.com/prod/';
